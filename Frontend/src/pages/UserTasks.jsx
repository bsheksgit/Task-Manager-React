        ...
        <div className="w-full flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <button
              ...
              className="cursor-pointer rounded-full bg-amber-600 p-4 text-black shadow-lg hover:scale-105 transform transition"
            >
              <span className="material-symbols-outlined rounded-full w-8 p-1 text-4xl">
                add_2
              </span>
            </button>
          </div>
